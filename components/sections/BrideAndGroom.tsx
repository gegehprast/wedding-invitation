    ...
    return (
        <>
            <div
                ...
                } w-full transition-opacity duration-1000 delay-[800ms] ease-in-out`}
            >
                ...
                <div
                    className={`${
                        !coverModalOpen
                            ? 'opacity-100'
                            : 'opacity-0 pointer-events-none'
                    } px-4 md:px-20 laptop:px-16 2xl:px-20 transition-opacity duration-1000 delay-[1000ms] ease-in-out`}
                >
                ...
                <div
                    className={`${
                        !coverModalOpen
                            ? 'opacity-100'
                            : 'opacity-0 pointer-events-none'
                    } mt-12 md:mt-16 lg:mt-32 laptop:mt-14 2xl:mt-24 transition-opacity duration-1000 delay-[1200ms] ease-in-out`}
                >
                ...
                <div
                    className={`${
                        !coverModalOpen
                            ? 'opacity-100'
                            : 'opacity-0 pointer-events-none'
                    } mt-10 md:mt-14 lg:mt-28 laptop:mt-10 2xl:mt-20 transition-opacity duration-1000 delay-[1400ms] ease-in-out`}
                >
                ...
                <div
                    className={`${
                        !coverModalOpen
                            ? 'opacity-100'
                            : 'opacity-0 pointer-events-none'
                    } mt-10 md:mt-14 lg:mt-28 laptop:mt-10 2xl:mt-20 transition-opacity duration-1000 delay-[1600ms] ease-in-out`}
                >
                    <h2 className="text-[2.75rem] leading-none text-center md:text-7xl laptop:text-5xl 2xl:text-7xl font-AlexBrush">
                        Almalia Deve Yanti
                    </h2>
