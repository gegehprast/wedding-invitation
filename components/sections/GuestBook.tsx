...
const GuestBook = () => {
    ...
    return (
        <>
            ...
            <div className='flex flex-col w-full px-2 mt-8 md:px-20 laptop:px-10 2xl:px-20 md:mt-14 lg:mt-28 laptop:mt-6 2xl:mt-24 font-Inter' onWheel={handleMessageWheel} ref={messageDivRef}>
                <div className={`overflow-y-scroll p-2 md:p-4 h-[65vh] 2xl:h-[59vh]`} >
            ...
            <div className='flex flex-row flex-wrap items-center justify-center w-full mt-4 font-Inter'>
                <button type='button' className='flex items-center px-3 py-1 mr-4 text-sm rounded-2xl bg-gold text-blue-floral hover:bg-gold2' onClick={() => setRemarkModalOpen(true)}>
                ...
                <button type='button' className='flex items-center px-3 py-1 text-sm rounded-2xl bg-gold text-blue-floral hover:bg-gold2' onClick={() => setAmplopModalOpen(true)}>
                    <span className='w-5 h-5 text-blue-floral'>
                        <Mail />
                    </span>
            ...
            <Remark messageDivRef={messageDivRef}
                setRemarks={setRemarks}
                open={remarkModalOpen}
                setOpen={setRemarkModalOpen} />

            <Amplop messageDivRef={messageDivRef}
                setRemarks={setRemarks}
