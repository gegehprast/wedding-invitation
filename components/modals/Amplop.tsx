...
const Amplop: React.FC<RemarkProps> = ({ messageDivRef, setRemarks, open, setOpen }) => {
    ...
    return (
        <div
            className={`${
                open ? 'block' : 'hidden'
            } absolute top-0 left-0 w-full h-full bg-blue-floral bg-opacity-50 font-Inter`}
        ...
        >
            <div className="absolute w-full px-2 transform -translate-x-1/2 -translate-y-1/2 md:px-20 laptop:px-10 2xl:px-20 top-1/2 left-1/2">
                <div
                    className="relative w-full p-2 bg-white border-b rounded-t-md border-gold"
                    onClick={handleContentClick}
                >
                    <h1 className="text-lg text-center">Amplop Online</h1>

                    <button
                        className="absolute top-1/4 right-[1rem]"
                ...
                <div
                    className="w-full p-4 pt-3 bg-white border-gold border-t rounded-b-md md:p-6 md:pt-3 max-h-[75vh] overflow-y-auto"
                    onClick={handleContentClick}
                >
                    <form
                        className="flex flex-col w-full text-blue-floral"
                    ...
                    >
                        <div className="flex flex-col justify-start w-full mt-2">
                            ...
                            />
                            <label className="text-[10px] md:text-xs text-blue-floral">
                                Beserta alamat singkat juga boleh 🤗.
                            </label>
                        </div>
                        ...
                        <div className="flex flex-col justify-start w-full mt-2">
                            ...
                            />
                            <label className="text-[10px] md:text-xs text-blue-floral">
                                Informasi kontak kamu tidak akan ditampilkan.
                            </label>
                        </div>
                        ...
                        <div className="flex flex-col justify-start w-full mt-2">
                            ...
                            />
                            <label className="text-[10px] md:text-xs text-blue-floral">
                                Rekening kamu tidak akan ditampilkan.
                            </label>
                        </div>
                        ...
                        <div className="flex flex-col justify-start w-full mt-2">
                            ...
                            />
                            <label className="text-[10px] md:text-xs text-blue-floral">
                                Nominal kamu tidak akan ditampilkan.
                            </label>
                        </div>
                        ...
                        <div className="flex flex-col justify-start w-full mt-2">
                            ...
                            />
                            <label className="text-[10px] md:text-xs text-blue-floral">
                                Ucapan yang telah dikirim tidak dapat dihapus.
                            </label>
                        </div>
                        ...
                        <div className="flex flex-col justify-start w-full mt-2">
                            <select
                                ...
                                required={true}
                                onChange={e =>
                                    setPresence(parseInt(e.target.value))
                                }
                            >
                                <option
                                    value={0}
                        ...
                        <div className="flex flex-col justify-start w-full mt-4">
                            <label className="text-sm text-blue-floral">
                                Silakan transfer ke rekening BCA atau scan kode
                                QRIS di bawah ini.
                            </label>
                        ...
                        <div className="flex flex-row flex-wrap items-center w-full mt-4">
                            <button
                                type="submit"
                                className="w-full px-3 py-1 text-sm rounded-2xl bg-gold text-blue-floral hover:bg-gold2"
                            >
